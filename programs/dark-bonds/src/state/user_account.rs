...
impl UserAccount {
    pub fn add_total_listed(&mut self, bank_index: u16, bond_index: u16) {
    ...
    pub fn remove_total_listed(&mut self, bank_index: u16, bond_index: u16) -> Result<()> {
    ...
    pub fn add_total_owned(&mut self, bank_index: u16, bond_index: u16) {
    ...
    pub fn remove_total_owned(&mut self, bank_index: u16, bond_index: u16) -> Result<()> {
        let blackbox_pointer = BondPointer {
            bank_index,
            bond_index,
        };
