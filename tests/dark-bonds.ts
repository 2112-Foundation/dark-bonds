...
describe("dark-bonds", async () => {
  ...
  // gate:  SplGate {
  //   address: PublicKey [PublicKey(AVGZfAjNRDPFKH2paKxaSazBfQBtKCqBngmSQuuMjUHS)] {
  //     _bn: <BN: 8cf70ace525976cd015d390ce070204d72b0ae1efed8f3f0a7fd9a0410be0655>
  //   },
  //   index: 1,
  //   mint: PublicKey [PublicKey(AdS3sefuPCoRqLiDN1hqgDdt2ftyJbxi97uW4KbWf98t)] {
  //     _bn: <BN: 8f0e6a41e5cad952d28e6e6ff428498f1c013722feb2500fde7c4181c92303e9>
  //   }
  // }  at idx:  1
  // Using bond counter:  5
  // Getting lockup idx:  5
  // Total lock-ups:  5
